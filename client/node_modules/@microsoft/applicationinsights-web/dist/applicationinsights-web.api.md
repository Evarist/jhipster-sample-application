...
// Warning: (ae-forgotten-export) The symbol "IDependencyInitializerDetails" needs to be exported by the entry point applicationinsights-web.d.ts
//
// @public
export type DependencyInitializerFunction = (item: IDependencyInitializerDetails) => boolean | void;

// Warning: (ae-forgotten-export) The symbol "IDependencyListenerDetails" needs to be exported by the entry point applicationinsights-web.d.ts
//
// @public
...
export interface IConfig {
    ...
    // Warning: (ae-forgotten-export) The symbol "IStorageBuffer" needs to be exported by the entry point applicationinsights-web.d.ts
...
// Warning: (ae-forgotten-export) The symbol "IDependencyHandler" needs to be exported by the entry point applicationinsights-web.d.ts
//
// @public (undocumented)
